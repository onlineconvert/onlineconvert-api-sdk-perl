...
# @param string $x_oc_api_key Api key for the user to filter. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ jobs_job_id_input_get } = { 
...
# @param string $x_oc_api_key Api key for the user to filter. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ jobs_job_id_input_post } = { 
...
# @param string $x_oc_api_key Api key for the user to filter. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ jobs_job_id_input_file_id_get } = { 
...
# @param string $x_oc_api_key Api key for the user to filter. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ jobs_job_id_input_file_id_delete } = { 
